...
if __name__ == "__main__":
    ...
    tweets_stream = pd.read_json(
        "./preprocessing/data/preprocessed/stream/tweets_stream.json")
    ...
    merged_tweets_image_metadata.to_json(
        "./preprocessing/data/preprocessed/merged/merged_tweets_image_metadata_stream.json", orient="records")
    ...
    merged_tweets_image_metadata.iloc[0:100, :].to_json(
        "./preprocessing/data/sample/merged_tweets_image_metadata_stream_sample.json", orient="records")
